window.wp = window.wp || {}, function (a, b) {
    ...
    }), e.Values = e.Class.extend({
        defaultConstructor: e.Value, initialize: function (a) {
    ...
    }), e.Element.synchronizer.checkbox = {
        update: function (a) {
            this.element.prop("checked", a)
        }, refresh: function () {
            return this.element.prop("checked")
        }
    }, e.Element.synchronizer.radio = {
        update: function (a) {
    ...
    }, b.support.postMessage = !!window.postMessage, e.Messenger = e.Class.extend({
        add: function (a, b, c) {
