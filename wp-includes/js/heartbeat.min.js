    ...
    var d = function () {
        ...
        function j() {
            ...
            z.connecting || z.suspend || (z.lastTick = e(), d = a.extend({}, z.queue), z.queue = {}, y.trigger("heartbeat-send", [d]), c = {
                ...
                var d;
                return a ? (i(), a.nonces_expired ? void y.trigger("heartbeat-nonces-expired") : (a.heartbeat_interval && (d = a.heartbeat_interval, delete a.heartbeat_interval), y.trigger("heartbeat-tick", [a, b, c]), void(d && t(d)))) : void h("empty")
            }).fail(function (a, b, c) {
