tinymce.PluginManager.add("image", function (a) {
    ...
    function e(d) {
        ...
        function f() {
            ...
            i(), e(), o = tinymce.extend(o, j.toJSON());
            var c = o.caption;
            o.alt || (o.alt = ""), "" === o.width && (o.width = null), "" === o.height && (o.height = null), o.style || (o.style = null), o = {
                src: o.src,
                alt: o.alt,
                width: o.width,
                height: o.height,
                ...
                var d = {node: q, data: o, caption: c};
                return a.fire("wpImageFormSubmit", {imgData: d}), d.cancel ? void b(d.node) : o.src ? (q ? p.setAttribs(q, o) : (o.id = "__mcenew", a.focus(), a.selection.setContent(p.createHTML("img", o)), q = p.get("__mcenew"), p.setAttrib(q, "id", null)), void b(q)) : void(q && (p.remove(q), a.focus(), a.nodeChanged()))
            })
        }
        ...
        k = p.getAttrib(q, "width"), l = p.getAttrib(q, "height"), "IMG" != q.nodeName || q.getAttribute("data-mce-object") || q.getAttribute("data-mce-placeholder") ? q = null : (o = {
            ...
            width: k,
            height: l
        }, a.fire("wpLoadImageData", {imgData: {data: o, node: q}})), d && (m = {
            type: "listbox",
            label: "Image list",
        ...
        var s = [{name: "src", type: "filepicker", filetype: "image", label: "Source", autofocus: !0, onchange: h}, m];
        a.settings.image_description !== !1 && s.push({
        ...
        }), s.push(n), a.fire("wpLoadImageForm", {data: s}), a.settings.image_advtab ? (q && (o.hspace = g(q.style.marginLeft || q.style.marginRight), o.vspace = g(q.style.marginTop || q.style.marginBottom), o.border = g(q.style.borderWidth), o.style = a.dom.serializeStyle(a.dom.parseStyle(a.dom.getAttrib(q, "style")))), j = a.windowManager.open({
            title: "Insert/edit image",
            data: o,
            bodyType: "tabpanel",
            body: [{title: "General", type: "form", items: s}, {
                title: "Advanced",
                type: "form",
                pack: "start",
                items: [{label: "Style", name: "style", type: "textbox"}, {
                    ...
                    padding: 0,
                    alignH: ["left", "right"],
                    defaults: {type: "textbox", maxWidth: 50, onchange: i},
            ...
            onSubmit: f
        })) : j = a.windowManager.open({title: "Insert/edit image", data: o, body: s, onSubmit: f})
    }
