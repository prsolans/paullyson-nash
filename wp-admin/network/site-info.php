...
<form method="post" action="site-info.php?action=update-site">
	...
	<table class="form-table">
		<tr class="form-field form-required">
			...
			<?php } else { ?>
				<td><?php echo $parsed['scheme'] . '://'; ?><input name="blog[domain]" type="text" id="domain"
																   value="<?php echo esc_attr($details->domain) ?>"/>
				</td>
			<?php } ?>
		</tr>
		<tr class="form-field form-required">
			...
			?>
				<td>
					...
					<label><input type="checkbox" name="update_home_url"
