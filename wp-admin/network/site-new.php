...
<?php wp_nonce_field( 'add-blog', '_wpnonce_add-blog' ) ?>
	<table class="form-table">
		<tr class="form-field form-required">
			...
			<?php } else {
				echo $current_site->domain . $current_site->path ?><input name="blog[domain]" class="regular-text"
																		  id="site-address" type="text"
		...
		<tr class="form-field form-required">
			...
			<td><input name="blog[title]" type="text" class="regular-text" id="site-title"
