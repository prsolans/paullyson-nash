		...
		<tr class="user-sessions-wrap hide-if-no-js">
			...
			<td aria-live="assertive">
				<div class="destroy-sessions">
					<button disabled
							class="button button-secondary"><?php _e('Log Out of All Other Sessions'); ?></button>
				</div>
				<p class="description">
			...
			<td aria-live="assertive">
				<div class="destroy-sessions">
					<button class="button button-secondary"
							id="destroy-sessions"><?php _e('Log Out of All Other Sessions'); ?></button>
				</div>
				<p class="description">
	...
	<?php elseif (!IS_PROFILE_PAGE && $sessions->get_all()) : ?>
		<tr class="user-sessions-wrap hide-if-no-js">
			...
			<td>
				<p>
					<button class="button button-secondary"
							id="destroy-sessions"><?php _e('Log Out of All Sessions'); ?></button>
				</p>
				<p class="description">
					<?php
