...
<h1><?php printf( __( 'Welcome to WordPress&nbsp;%s' ), $display_version ); ?></h1>
	...
	<div
		class="about-text"><?php printf(__('Thank you for updating! WordPress %s helps you focus on your writing, and the new default theme lets you show it off in style.'), $display_version); ?></div>
	...
	<div class="changelog feature-list finer-points">
		...
		<div class="feature-section col two-col">
			...
			<div>
				<svg viewBox="-30 -30 160 160">
					<path
						d="M61.4,78.6V61.4L72.9,50v40H10V27.1h45.7L44.3,38.6H21.4v40H61.4z M44.3,10H90v45.7L78.6,50V32.4l-32,31.9l-8.1-8.1 l34.8-34.9H50L44.3,10z"/>
				</svg>
